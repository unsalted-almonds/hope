 ...
 * Created by Shilin_Gan on 12/5/2017.
 */
public class MineSweeper {
    ...
    public char[][] updateBoard(char[][] board, int[] click) {
        ...
        int numberOfMines = getNumberOfMines(board, click);
        if (numberOfMines > 0) {
            board[clickX][clickY] = ("" + numberOfMines).charAt(0);
            return board;
        }
    ...
    private int getNumberOfMines(char[][] board, int[] pos) {
        int res = 0;
        int[] dx = new int[]{0, 0, 1, -1, -1, 1, -1, 1};
        int[] dy = new int[]{1, -1, 0, 0, -1, 1, 1, -1};
